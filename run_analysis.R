...
#       2016-03-13
#
# This script uses data from the following link 
...
# Set working directory - where files were unzipped
setwd("/Users/minpark/Documents/_Work/Courses/DS03-CleaningData/Week 4/UCI HAR Dataset")
getwd()
...
# 1. Merge the training and the test sets to create one data set.
        ...
        # Do some cleanup, assign column headers
        ...
        # Created conslidated testing and training data 
                trainingData <- cbind(yTrain,subjectTrain,xTrain);
                testingData  <- cbind(yTest,subjectTest,xTest);


        # Combine training and testing data to create a final data set
                finalData    <- rbind(trainingData,testingData);

                # Create a vector if column head from the finalData, for later
